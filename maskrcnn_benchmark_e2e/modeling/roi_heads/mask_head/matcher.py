...
class MatchERT(nn.Module):
    def __init__(self, d_model=128, nhead=4, num_encoder_layers=6, dim_feedforward=1024, dropout=0.0, activation='relu', normalize_before='False'):
    ...
    def forward(self, src_local, tgt_local, normalize=False):
