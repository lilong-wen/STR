...
from maskrcnn_benchmark_e2e.structures.boxlist_ops import cat_boxlist, cat_boxlist_gt
from maskrcnn_benchmark_e2e.structures.boxlist_ops import remove_small_boxes
from maskrcnn_benchmark_e2e.structures.segmentation_mask import SegmentationMask
import random
