...
import torch
from maskrcnn_benchmark_e2e.utils.comm import get_world_size, is_main_process
from maskrcnn_benchmark_e2e.utils.metric_logger import MetricLogger
...
def do_train(
    ...
    logger = logging.getLogger("maskrcnn_benchmark_e2e.trainer")
